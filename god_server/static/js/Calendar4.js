	...
	Today:function()  //Today Button
  	{
        ...
        if(this.L_TheMonth < 10){
            today=new Date().getDate();
            if(today < 10){
                    if(this.InputObject){
                    this.InputObject.value=this.L_TheYear + "-" + "0" + this.L_TheMonth + "-" + "0" + today;
                    }
                          }
            else{
                    if(this.InputObject){
                    this.InputObject.value=this.L_TheYear + "-" + "0" + this.L_TheMonth + "-" + today;
                    }
            ...
            if(today < 10){
                    if(this.InputObject){
                    this.InputObject.value=this.L_TheYear + "-" + this.L_TheMonth + "-" + "0" + today;
                    }
                          }
            else{
                    if(this.InputObject){
